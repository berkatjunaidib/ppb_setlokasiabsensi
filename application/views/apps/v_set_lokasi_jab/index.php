...
<section class="content">
	<div class="container-fluid">
		<?php $this->load->view('apps/v_set_lokasi_jab/tab'); ?>
		<div class="card card-info card-outline">
			<div class="card-body">
				<form name="form1" id="index1" action="#" class="form-search">
							...
							<td>
								<select name="id_jenis_jabatan" class="form-control">
									...
									foreach ($response as $key => $value) {
										?>
										<option value="<?php echo $value->id_jenis_jabatan; ?>"><?php echo $value->id_jenis_jabatan; ?>-<?php echo $value->nama_jenis_jabatan; ?></option>
										<?php
						...
						<table class="table table-condensed">
							<thead>
								<tr>
									...
									<th class="span1" style="cursor: pointer;" onclick="func_sidx('nip')" id="nip">nama_pegawai<span id="nama_pegawai_sort" class="sort"></span></th>
									<th class="span1" style="cursor: pointer;" onclick="func_sidx('nip')" id="nip">nama_jenis_jabatan<span id="nama_pegawai_sort" class="sort"></span></th>
								</tr>
							</thead>
							<tbody id="view_data">
							</tbody>
...
<script type="text/javascript">
	var main = "<?php echo base_url(); ?>apps/c_set_lokasi_jab/views?mod=v";
	var row = "<?php echo base_url(); ?>apps/c_set_lokasi_jab/views";
	//func_view();
	...
	function func_refresh(){
		eksekusi_get('<?php echo base_url(); ?>apps/c_set_lokasi_jab');
	}
	function proses_confirm(){
		if(confirm("Apakah anda yakin?")){
			var method = "<?php echo base_url(); ?>apps/c_set_lokasi_jab/";
			var form_op = "proses";
			var string = $("#index1").serialize();
	...
	$('#nip').autocomplete({
		source: function(request, response) {
			$.getJSON("<?php echo base_url().'apps/c_set_lokasi_jab/set_lokasi_auto';?>",{term: request.term},response);
		},
		minLength:1,	

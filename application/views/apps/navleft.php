...
<div class="sidebar force-overflow" id="style-1">
	...
	<div class="image" style="float: left;">
		<img style="margin: 20px 10px; width: 30px;" src="<?php echo config_item('asset_url'); ?>assets/apps/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
	</div>
	<div class="info" style="margin: 0 5px;padding: 0 5px;">
		<a href="javascript:eksekusi_get('<?php echo base_url();?>apps/c_edit_profil')" class="d-block" style="margin: 0;padding: 0">
			[<?php echo $this->session->userdata('arrayLogin')['id_pegawai']; ?>]
			[<?php echo $this->session->userdata('arrayLogin')['nip']; ?>]
		</a>
		<span style="color: #eee;"><?php echo $this->session->userdata('arrayLogin')['nama_pegawai']; ?></span><br>
		<span style="color: #eee;"><?php echo $this->session->userdata('arrayLogin')['group_user_str'] ?></span>
	</div>
	<!-- Sidebar Menu -->

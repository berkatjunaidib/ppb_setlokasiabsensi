<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Laporan Lokasi Absensi rekap</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo base_url();?>apps/home">Home</a></li>
					<li class="breadcrumb-item active">Laporan Lokasi Absensi rekap</li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		<?php $this->load->view('apps/v_lap_lokasi_rekap/tab'); ?>
...
<script type="text/javascript">
	var main = "<?php echo base_url(); ?>apps/c_lap_lokasi_rekap/views?mod=v";
	var row = "<?php echo base_url(); ?>apps/c_lap_lokasi_rekap/views";
	//func_view();
	...
	function func_refresh(){
		eksekusi_get('<?php echo base_url(); ?>apps/c_lap_lokasi_rekap');
	}
	function proses_confirm(){
		if(confirm("Apakah anda yakin?")){
			var method = "<?php echo base_url(); ?>apps/c_lap_lokasi_rekap/";
			var form_op = "proses";
			var string = $("#index1").serialize();
	...
	$('#nip').autocomplete({
		source: function(request, response) {
			$.getJSON("<?php echo base_url().'apps/c_lap_lokasi_rekap/set_lokasi_auto';?>",{term: request.term},response);
		},
		minLength:1,	
